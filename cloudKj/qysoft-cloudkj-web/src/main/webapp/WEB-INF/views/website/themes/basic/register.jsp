                    ...
                    <form class="login-form" action="${ctxStatic}/qysoftui/system/loginValidate" method="post" id="regionForm" style="margin: 0px 0 20px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" data-fv-notempty="true"
                                   ...
                                   data-fv-identical-field="password2" data-fv-identical-message="两次输入内容不一致"--%> placeholder="请输入密码(密码大于八位且不能有特殊字符)">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" id="regBtn" class="btn btn-block margin-top-30" style="background: #ff7000;color:#fff;">注 册</button>
                    </form>
                </div>
            </div>
...
<script type="text/javascript" data-deps="formValidation">
    ...
    function getVerify() {
        ...
        if(!(/^1[1|3|4|5|7|8][0-9]\d{4,8}$/.test(sMobile))){
            alert("不是正确的手机号码格式");
            return;
        }
        var param = {
