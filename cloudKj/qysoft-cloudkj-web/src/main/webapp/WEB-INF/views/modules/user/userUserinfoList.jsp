...
<body>
	...
	<form:form id="searchForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<%--</li>--%>
			<%--<li><label>用户等级：</label>--%>
				<%--<form:select path="userLevelId" class="input-medium">--%>
					<%--<form:option value="" label="全部"/>--%>
					<%--<form:options items="${userLevelList}" itemLabel="levelName" itemValue="levelCode" htmlEscape="false" />--%>
				<%--</form:select>--%>
			<%--</li>--%>
			<%--<li><label>团队等级：</label>--%>
				<%--<form:select path="userType" class="input-medium">--%>
					<%--<form:option value="" label="全部"/>--%>
					<%--<form:options items="${userTeamList}" itemLabel="teamName" itemValue="teamCode" htmlEscape="false" />--%>
				<%--</form:select>--%>
			<%--</li>--%>
			<li><label>注册时间：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="userUserinfo">
			<tr>
				...
				<%--</td>--%>
				<td>
					${userUserinfo.money6 == "0.0000000000"?0:userUserinfo.money6}
				</td>
				<td>
					${userUserinfo.money5}
				</td>
