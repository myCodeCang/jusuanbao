...
<body>
	...
	<form:form id="searchForm" modelAttribute="btcAccountchange" action="${ctx}/machine/btcAccountchange/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="btcAccountchange">
			<tr>
				...
				<td>
					${btcAccountchange.beforeMoney}
				</td>
				<td>
					${btcAccountchange.afterMoney}
				</td>
				<td>
