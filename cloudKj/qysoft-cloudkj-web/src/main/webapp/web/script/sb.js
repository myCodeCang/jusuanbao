"use strict";
! function() {
	if(!window.SOSOBTC || !window.SOSOBTC.widget) {
		var e = {
			...
			urlBuilderFunction: function(e) {
				for(var n = "", t = "", o = "", r = "", i = "", a = "", d = "", u = 0; u < e.length; u++)
					...
					return n.indexOf("#") !== -1 && (d = n.substring(n.indexOf("#")), n = n.substring(0, n.indexOf("#"))), n.indexOf("/", 9) === -1 && n.indexOf("?") === -1 && (n += "/"), n += n.indexOf("?") === -1 ? "?" : "&", n += "utm_source=" + t + "&utm_medium=" + o, "" != r && (n += "&utm_term=" + r), "" != i && (n += "&utm_content=" + i), n += "&utm_campaign=" + a, d && (n += d), n
			},
			widget: function(n) {
				this.id = e.uid();
				...
				this.options = {
					...
					default_step: n.default_step,
					default_theme: n.default_theme,
					disable_theme_change: n.disable_theme_change,
					default_open_tools: n.default_open_tools,
					hide_logo: n.hide_logo,
					hide_market_name: n.hide_market_name
		...
		e.widget.prototype = {
			create: function() {
				var t, o = this.render(),
					r = this;
				n(o, this.options.container), t = e.$(this.id), e.bindEvent(t, "load", function() {
					r._ready = !0
				})
			},
			ready: function(e) {
			...
			generateUrl: function(n) {
				...
				var o = "/widget/",
					...
					i = e.urlBuilderFunction([{
						name: "website",
						value: r + o + "?symbol=" + encodeURIComponent(n.symbol) + t("default_step", n.default_step) + t("default_theme", n.default_theme) + t("disable_theme_change", n.disable_theme_change) + t("default_open_tools", n.default_open_tools) + t("hide_logo", n.hide_logo) + t("hide_market_name", n.hide_market_name)
					}, {
						name: "utm_source",
			...
			for(var e = /\+/g, n = /([^&=]+)=?([^&]*)/g, t = window.location.search.substring(1), o = n.exec(t), r = function(n) {
					return decodeURIComponent(n.replace(e, " "))
				}, i = {}; o;) i[r(o[1])] = r(o[2]), o = n.exec(t);
			return i
		...
		window.SOSOBTC && jQuery ? jQuery.extend(window.SOSOBTC, e) : window.SOSOBTC = e
	}
}();